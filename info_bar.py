...
class InfoBar(ProtoAnim):
    ...
    def populate_text_canvas(self):
        ...
        self.my_canvas[InfoBar.TEXT].create_text(15, 12, anchor="nw", text="asdf", tag="bigtext",
                                                 font="helvetica 12 bold", width=120)
        self.my_canvas[InfoBar.TEXT].create_text(15, 30, anchor="nw", text="asdf", tag="smalltext",
                                                 font="helvetica 9 italic", width=120)
    ...
    def populate_hpmp_canvas(self):
        ...
        hpcanvas = tk.Canvas(self.my_canvas[InfoBar.HPMP], bg='pink', width=m_c.bar_w, height=m_c.bar_h,
                             highlightthickness=0)
        msg_hp.attach_canvas(hpcanvas)
        msg_hp.create_bar_image()
        hpcanvas.grid(row=0, column=0)
        # MP Bar
        mpcanvas = tk.Canvas(self.my_canvas[InfoBar.HPMP], bg='pink', width=m_c.bar_w, height=m_c.bar_h,
                             highlightthickness=0)
    ...
    def attach_canvas(self, canvas=None):
        ...
        self.my_canvas[InfoBar.TEXT] = tk.Canvas(self.info_frame, bg='light gray', width=m_c.hover_w,
                                                 height=m_c.hover_h, highlightthickness=0)
        self.my_canvas[InfoBar.HPMP] = tk.Canvas(self.info_frame, bg='green', width=m_c.hover_w, height=m_c.hover_h,
                                                 highlightthickness=0)
