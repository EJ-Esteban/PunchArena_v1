...
class PointBar(ProtoAnim):
    ...
    def create_bar_image(self):
        ...
        self.my_canvas.create_text(105,8,font=m_c.barfonts,anchor=tk.NW,text=str(self.cur_val)+"/",tag="curtext", width = "40")
        self.my_canvas.create_text(105,22,font=m_c.barfonts,anchor=tk.NW,text=str(self.max_val), tag="maxtext", width = "40")
